...
const completeBtn = document.querySelector("#completeBtn"); // 완료 여부 변경 버튼 클릭 시
const deleteBtn = document.querySelector("#deleteBtn"); // 삭제 버튼 클릭 시
const updateBtn = document.querySelector("#updateBtn"); // 수정 버튼 클릭 시 
